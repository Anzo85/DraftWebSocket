...
public class
JabberImplement implements Jabber {
    public static void main(String[] args) throws Exception {

        JabberImplement jabber = new JabberImplement();
        AbstractXMPPConnection connection = jabber.connection("user", "user");
        connection.login();
    ...
    public void chat(AbstractXMPPConnection connection, String user, String msg) throws SmackException.NotConnectedException {
